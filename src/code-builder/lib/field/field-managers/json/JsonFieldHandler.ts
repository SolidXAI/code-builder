...
import { JsonFieldManagerForDto } from './JsonFieldManagerForDto';
import { JsonFieldManagerForEntity } from './JsonFieldManagerForEntity';

export class JsonFieldHandler implements FieldHandler {
  ...
  constructor(
    ...
    this.updateDtoFieldManager = new JsonFieldManagerForDto(
      tree,
      moduleName,
      modelName,
      field,
