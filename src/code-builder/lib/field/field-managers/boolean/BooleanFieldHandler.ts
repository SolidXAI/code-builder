...
import { BooleanFieldManagerForDto } from './BooleanFieldManagerForDto';
import { BooleanFieldManagerForEntity } from './BooleanFieldManagerForEntity';

export class BooleanFieldHandler implements FieldHandler {
  ...
  constructor(tree: any, moduleName: string, modelName: string, field: any, modelEnableSoftDelete: any) {
    ...
    this.updateDtoFieldManager = new BooleanFieldManagerForDto(
      tree,
      moduleName,
      modelName,
      field,
