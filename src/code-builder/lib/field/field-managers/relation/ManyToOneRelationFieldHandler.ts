...
import { ManyToOneRelationFieldManagerForDto } from './ManyToOneRelationFieldManagerForDto';
import { ManyToOneRelationFieldManagerForEntity } from './ManyToOneRelationFieldManagerForEntity';


export class ManyToOneRelationFieldHandler implements FieldHandler {
  ...
  constructor(tree: any, moduleName: string, modelName: string, field: any, modelEnableSoftDelete: any) {
    ...
    this.updateDtoFieldManager = new ManyToOneRelationFieldManagerForDto(
      tree,
      moduleName,
      modelName,
      field,
