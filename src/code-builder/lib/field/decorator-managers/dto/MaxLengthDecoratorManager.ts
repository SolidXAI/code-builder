...
export interface MaxLengthDecoratorOptions {
  isApplyMaxLength: boolean;
  length: number;
  source: ts.SourceFile;
  field: any;
}
export class MaxLengthDecoratorManager implements DecoratorManager {
  constructor(public options: MaxLengthDecoratorOptions, public fieldNode?: any) { }
