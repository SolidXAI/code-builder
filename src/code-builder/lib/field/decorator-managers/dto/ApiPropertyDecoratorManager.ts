...
export interface ApiPropertyDecoratorOptions {
  isApplyApiProperty: boolean;
  source: ts.SourceFile;
  field: any;
}
export class ApiPropertyDecoratorManager implements DecoratorManager {
  constructor(public options: ApiPropertyDecoratorOptions, public fieldNode?: any) { }
