...
export class EmailDecoratorManager implements DecoratorManager {
  constructor(public options: EmailDecoratorOptions, public fieldNode?: PropertyDeclaration | undefined) { }
  isApplyDecorator(): boolean {
    return this.options.isEmail;
  }
